                        ...
                        <form className="mt-8 space-y-4">
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input ref={emailRef} onChange={(e) => setEmail(e.target.value)} name="username" type="text" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Email" />
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input ref={passwordRef} onChange={(e) => setPassword(e.target.value)} name="password" type="password" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter password" />
                            ...
                            <div className="mt-8 flex flex-col gap-7">
                                ...
                                {error !== '' && <div className='p-1  text-red text-center font-bold'>{error}</div>}
                            </div>
